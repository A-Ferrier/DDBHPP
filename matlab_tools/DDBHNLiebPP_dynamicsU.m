...
% Code to check time evolution of occupations & g2 for N unit cell 1D DDBH Lieb Positive P with spatial averaging (for use with spatially uniform parameters)
