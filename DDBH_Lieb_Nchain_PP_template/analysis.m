...
N = 3; % Number of unit cells (3N sites)
...
filenameout = ['analysis_output_DDBH_Lieb_' num2str(N) 'chain_Delta' correctnum2str(Delta) '_U' correctnum2str(U) '_F' correctnum2str(F) '_J' correctnum2str(J) '_tf' num2str(tf)  '.mat'];

%Read simulation output files and collect data
[t, alphaA, alphaB, alphaC, betaA, betaB, betaC] = DDBHNLiebPP_output_sample(N, Delta, U, F, J, tf, nsamples);
